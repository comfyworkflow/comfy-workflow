...
echo ========================================================
echo  Repo: https://github.com/comfyworkflow/comfy-workflow
echo ========================================================
echo.
...
echo.
echo =========================================================================
echo   ComfyUI base install complete^^!
echo =========================================================================
echo.
echo   ComfyUI portable installed at:
echo     C:\ComfyUI_windows_portable\
echo.
...
echo =========================================================================
echo.
echo  Manual step: enable "Node ID Badge Mode" in ComfyUI settings ^(see above^).
echo.
