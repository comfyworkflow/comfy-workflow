@echo off
REM ============================================================================
REM Comfy Workflow - FLUX.1 (5 variants × 3 aspect workflows)
REM ============================================================================
...
echo.
echo ========================================================
echo  Comfy Workflow - FLUX.1 (5 variants × 3 aspect workflows)
echo ========================================================
echo  Pillars: #2, #1
...
echo [1/3] Downloading model files (total: ~82.11 GiB)...
...
echo [2/3] Installing custom nodes...
call :ensure_custom_node "ComfyUI-GGUF" "https://github.com/city96/ComfyUI-GGUF.git"

echo [3/3] Shipping 3 workflow file(s)...
call :ship_workflow "flux_base.json"
call :ship_workflow "flux_base_landscape.json"
call :ship_workflow "flux_base_portrait.json"

echo.
echo ========================================================
echo  DONE - FLUX.1 (5 variants × 3 aspect workflows)
echo ========================================================
echo.
echo  Next steps:
echo    1. Run C:\ComfyUI_windows_portable\run_nvidia_gpu.bat
echo    2. Open ComfyUI in browser, load workflow:
echo        ComfyUI -^> Workflows -^> flux_base.json
echo        ComfyUI -^> Workflows -^> flux_base_landscape.json
echo        ComfyUI -^> Workflows -^> flux_base_portrait.json
echo.
if not defined COMFY_NONINTERACTIVE pause
endlocal
exit /b 0
