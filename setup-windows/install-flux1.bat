@echo off
REM ============================================================================
REM Comfy Workflow - FLUX.1 (3 variants pre-wired)
REM ============================================================================
...
REM ============================================================================
REM Pillars: #2, #1
REM Models (from models_manifest.yaml): flux_dev_fp8, flux_dev_fp16, flux_schnell_fp8, flux_shared_encoders, flux_shared_vae
REM Hardware minimo: 32 GB RAM, 10 GB VRAM
REM Total download (this script): ~63.94 GiB
REM ============================================================================
...
echo.
echo ========================================================
echo  Comfy Workflow - FLUX.1 (3 variants pre-wired)
echo ========================================================
echo  Pillars: #2, #1
echo  Hardware minimo: 32 GB RAM, 10 GB VRAM
echo  Total download: ~63.94 GiB
echo ========================================================
echo.
...
echo [1/3] Downloading model files (total: ~63.94 GiB)...
...
echo [2/3] Pruning legacy flat-layout workflow files (flux_*.json)...
...
echo =========================================================================
echo.
echo   Models installed: fp16, fp8, schnell (3 variants)
echo.
echo   Workflows in ComfyUI sidebar:
echo     Comfy Workflow ^> Image ^> FLUX ^> (3 variants)
echo.
