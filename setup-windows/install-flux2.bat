@echo off
REM ============================================================================
REM Comfy Workflow - FLUX.2 dev GGUF (Q4_K_M)
REM ============================================================================
...
REM ============================================================================
REM Pillars: #2, #4
REM Models (from models_manifest.yaml): flux_2_dev_q4km, flux_2_shared_encoder, flux_2_shared_vae
REM Hardware minimo: 48 GB RAM, 12 GB VRAM
REM Total download (this script): ~35.70 GiB
REM ============================================================================
...
echo.
echo ========================================================
echo  Comfy Workflow - FLUX.2 dev GGUF (Q4_K_M)
echo ========================================================
echo  Pillars: #2, #4
echo  Hardware minimo: 48 GB RAM, 12 GB VRAM
echo  Total download: ~35.70 GiB
echo ========================================================
echo.
...
echo [1/3] Downloading model files (total: ~35.70 GiB)...
call :download_or_skip "https://huggingface.co/unsloth/FLUX.2-dev-GGUF/resolve/main/flux2-dev-Q4_K_M.gguf" "C:\ComfyUI_windows_portable\ComfyUI\models\diffusion_models\flux2-dev-Q4_K_M.gguf" 19959731168
call :download_or_skip "https://huggingface.co/Comfy-Org/flux2-dev/resolve/main/split_files/text_encoders/mistral_3_small_flux2_fp8.safetensors" "C:\ComfyUI_windows_portable\ComfyUI\models\text_encoders\mistral_3_small_flux2_fp8.safetensors" 18034640095
...
echo [3/3] Shipping 1 workflow file(s)...
call :ship_workflow "flux2_dev_gguf.json"

echo.
echo ========================================================
echo  DONE - FLUX.2 dev GGUF (Q4_K_M)
echo ========================================================
echo.
echo  Next steps:
echo    1. Run C:\ComfyUI_windows_portable\run_nvidia_gpu.bat
echo    2. Open ComfyUI in browser, load workflow:
echo        ComfyUI -^> Workflows -^> flux2_dev_gguf.json
echo.
if not defined COMFY_NONINTERACTIVE pause
endlocal
exit /b 0
