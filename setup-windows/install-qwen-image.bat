@echo off
REM ============================================================================
REM Comfy Workflow - Qwen-Image 2512 (V2 fp8 + V3 Lightning)
REM ============================================================================
...
REM ============================================================================
REM Pillars: #3
REM Models (from models_manifest.yaml): qwen_image_2512_fp8, qwen_lightning_lora_2512_4step, qwen_shared_encoders, qwen_shared_vae
REM Hardware minimo: 32 GB RAM, 12 GB VRAM
REM Total download (this script): ~29.59 GiB
REM ============================================================================
...
echo.
echo ========================================================
echo  Comfy Workflow - Qwen-Image 2512 (V2 fp8 + V3 Lightning)
echo ========================================================
echo  Pillars: #3
echo  Hardware minimo: 32 GB RAM, 12 GB VRAM
echo  Total download: ~29.59 GiB
echo ========================================================
echo.
...
echo [1/3] Downloading model files (total: ~29.59 GiB)...
...
call :ship_workflow "qwen_image_2512_lightning4.json"
...
echo =========================================================================
echo.
echo   Models installed: 2512 fp8 + Lightning 4-step LoRA
echo.
echo   Workflows in ComfyUI sidebar:
echo     Comfy Workflow ^> Image ^> Qwen ^> (2 variants)
echo.
echo   Default recommendation: qwen_image_2512.json (V2 fp8)
echo   For fast drafts: qwen_image_2512_lightning4.json (4 steps, 7.9x faster)
echo.
