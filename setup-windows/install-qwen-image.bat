@echo off
REM ============================================================================
REM Comfy Workflow - Qwen-Image 2512 (fp8 + bf16 × 5 aspects = 10 workflows)
REM ============================================================================
...
REM Hardware minimo: 32 GB RAM, 12 GB VRAM
REM Total download (this script): ~74.35 GiB
REM ============================================================================
...
echo.
echo ========================================================
echo  Comfy Workflow - Qwen-Image 2512 (fp8 + bf16 × 5 aspects = 10 workflows)
echo ========================================================
echo  Pillars: #3
echo  Hardware minimo: 32 GB RAM, 12 GB VRAM
echo  Total download: ~74.35 GiB
echo ========================================================
echo.
...
echo [1/3] Downloading model files (total: ~74.35 GiB)...
call :download_or_skip "https://huggingface.co/Comfy-Org/Qwen-Image_ComfyUI/resolve/main/split_files/diffusion_models/qwen_image_2512_fp8_e4m3fn.safetensors" "C:\ComfyUI_windows_portable\ComfyUI\models\diffusion_models\qwen_image_2512_fp8_e4m3fn.safetensors" 20430679144
...
echo =========================================================================
echo.
echo   Models installed: 2512 fp8 (19 GB) + 2512 bf16 (38 GB) + Lightning 4-step LoRA (1.7 GB) + full bf16 CLIP (16.6 GB) + VAE (0.3 GB)
echo.
echo   Workflows in ComfyUI sidebar:
echo     Comfy Workflow ^> Image ^> Qwen ^> (10 variants: 2 model × 5 aspect)
echo.
echo   Default recommendation: qwen_2512_fp8_1x1.json (best balance, native 1328×1328)
echo   For max precision: qwen_2512_bf16_1x1.json (reference quality, ~2× slower)
echo   For fast Lightning 4-step: see Note inside any workflow — add a LoraLoaderModelOnly + tweak KSampler
echo.
