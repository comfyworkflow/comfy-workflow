...
echo.
echo =========================================================================
echo   SDXL install complete^^!
echo =========================================================================
echo.
echo   Model installed: SDXL Base 1.0
echo.
echo   Workflows in ComfyUI sidebar:
echo     Comfy Workflow ^> Image ^> SDXL ^> (5 aspect variants)
echo.
echo   Tutorial video ^(Video #2 - SDXL install + benchmark^):
